...
const loginRoute = require('./Controllers/loginRoute.js')

//// RBAC

// exec import - confidential
const CreateConfidential = require('./Routes/Roles/1-Executive/Confidential File/createConfidentialFile.js')
const DeleteConfidential = require('./Routes/Roles/1-Executive/Confidential File/deleteConfidentialFile.js')
const ShowConfidential = require('./Routes/Roles/1-Executive/Confidential File/showConfidentialFile.js')
const UpdateConfidential = require('./Routes/Roles/1-Executive/Confidential File/updateConfidentialFile.js')

// exec imports - classified
const CreateClassified = require('./Routes/Roles/1-Executive/Classified File/createClassified.js');
...
const UnclassifiedFiles = require('./Routes/Files/ClassifiedFiles/unclassified')



//// routes

// IMPORTANT: for each route, indicate the role allowed to that route : ["production","management","admin","executive"]
// example : WhatRole(["admin"])


// controller routes
router.use('/login', loginRoute ); // this is login
...
router.use('/executive/create-classified-file', CreateClassified);
...
router.use('/files/unclassified', UnclassifiedFiles);
